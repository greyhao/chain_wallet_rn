...
import { View, Text, Button, Image, ActivityIndicator, FlatList } from "react-native";
...
const ReceiveTransactionsView = ({ route, navigation }) => {
...
export default ReceiveTransactionsView;